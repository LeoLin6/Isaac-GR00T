...
class KBotDataConfig(BaseDataConfig):
    video_keys = ["video.left", "video.right"]
    state_keys = ["state.left_arm", "state.right_arm", "state.right_hand"]
    action_keys = ["action.left_arm", "action.right_arm", "action.right_hand"]
    language_keys = ["annotation.human.task_description"]  # normalized
